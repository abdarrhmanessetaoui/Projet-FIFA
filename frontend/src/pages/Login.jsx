...
const GoogleIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12.48 10.92v3.28h7.84c-.24 1.84-.908 3.152-1.928 4.176-1.152 1.152-2.904 2.392-6.216 2.392-5.328 0-9.432-4.32-9.432-9.648s4.104-9.648 9.432-9.648c2.88 0 5.12 1.136 6.68 2.592l2.304-2.304C18.664 1.44 15.688 0 12.48 0 5.864 0 0 5.376 0 12s5.864 12 12.48 12c3.568 0 6.64-1.184 8.84-3.52 2.296-2.296 2.92-5.464 2.92-8.032 0-.768-.064-1.488-.176-2.112H12.48z"/>
  </svg>
);
      ...
      <div className="login-wrap">
        <div className="card">
          ...
          <div className="soc-grid">
            <button className="soc-btn" style={{ width: "100%" }} onClick={() => handleSocialLogin("google")}><GoogleIcon /> Google</button>
          </div>
